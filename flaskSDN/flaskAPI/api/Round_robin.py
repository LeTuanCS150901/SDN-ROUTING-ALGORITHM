...
class flowRule(object):
    """
    Round_robin object generates json file which adds flow
    """
    ...
    def create_flow_rule(self, flows):  
        ...
        for link in range ( len (self.shortest_path) ):
                    ...
                    flow = Flow.Flow(priority = 200, timeout = 0, isPermanent = True, deviceId = device.get_id()  )
...
class hostServerConnectionRR(object):
    ...
    def __init__(self, queue_rr, topo, graph, hosts, servers):
        ...
        # khoi tao Queue dest rabbit
        # self.queue_rr = destQueueRabbit.destQueueRabbit()
        ...
        # # khoi tao Queue Round Robin
        # self.queue_rr = QueueRR.QueueRR()

    # def server_to_rabbit(self):
    #     print("hello server")
    #     # print(self.servers)

    #     # day ip sang rabbit
    #     for ip in self.servers:
    #         self.queue_rr.connectRabbitMQ(ip_dest= ip)
    ...
    def find_shortest_path(self):
        ...
        # print("lay ip: ",dest_ip)
        # print("Remove: ",dest_ip)
        self.queue_rr.connectRabbitMQ(ip_dest= dest_ip)
    
        
        # self.queue_rr.append_queue(dest_ip)
